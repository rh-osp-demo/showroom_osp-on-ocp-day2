...
2. In the top panel, Instances, click on the instance: haproxy-{guid}
...
openstack volume delete haproxy-{guid}-2000
openstack port delete haproxy-{guid}-NIC-0-VLAN-private
----
