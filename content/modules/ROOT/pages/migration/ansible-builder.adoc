...
podman tag localhost/rhospvmt-ee:latest \
  aap-aap.apps.cluster-{guid}.dynamic.redhatworkshops.io/rhospvmt-ee:latest
----
...
podman login aap-aap.apps.cluster-{guid}.dynamic.redhatworkshops.io -u admin -p {aap_controller_admin_password}
----

[source,bash,role=execute,subs=attributes]
----
# Push to registry
podman push aap-aap.apps.cluster-{guid}.dynamic.redhatworkshops.io/rhospvmt-ee:latest
----
