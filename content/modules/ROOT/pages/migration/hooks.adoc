...
----
./govc: datacenter 'RS00' not found
----
use the following command to set the datacenter:
[source,bash,role=execute]
----
export GOVC_DATACENTER='RS01'
export GOVC_DATASTORE='workload_share_kc7AL'
...
openstack server add floating ip rhel4hooks {FLOATING_IP}
----
...
[source,bash,role=execute]
----
openstack server delete rhel4hooks
openstack volume delete rhel4hooks-2000
openstack port delete rhel4hooks-NIC-0-VLAN-private
----