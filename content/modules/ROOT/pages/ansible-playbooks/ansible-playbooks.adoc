...
all:
  vars:
    ...
    rhoso_public_net_start: {rhoso_public_net_start}" 
    rhoso_public_net_end: {rhoso_public_net_end}"
    rhoso_conversion_host_ip: "{rhoso_conversion_host_ip}"
